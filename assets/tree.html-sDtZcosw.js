...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>:::</p><h4 id="右旋——ll" tabindex="-1"><a class="header-anchor" href="#右旋——ll"><span>右旋——LL</span></a></h4><p><strong>右旋操作</strong></p><p><img src="`+d+'" alt="右旋操作——concept"></p><p>上图就是对Y结点进行右旋操作的流程，有了左旋操作的基础这里应该很好理解了。</p><p>第一步同样仅仅将Y结点右旋，成为X的一个结点，同样这里会出现问题X有了三个结点。</p><p>第二步，如果一开始Y左子树存在右结点，上图中也就是B结点，则将其设置为Y的右孩子。</p><p>到这里一个标准的右旋流程就完成了。</p><p><strong>右旋操作具体应用</strong></p><p>我们看一个右旋的例子，如图：</p><p><img src="'+t+`" alt="右旋操作——example"></p><p>在我们插入结点1的时候就会出现不平衡现象，结点5的平衡因子变为2，这里我们将结点5进行右旋，变为右图就又变为一颗AVL树了。</p><p><strong>代码实现</strong></p><div class="language-C line-numbers-mode" data-ext="C" data-title="C"><pre class="language-C"><code>private void right_rotate(AVL&lt;E&gt;.Node&lt;E&gt; t) {
    if (t != null) {
        Node&lt;E&gt; tl = t.left;
        t.left =tl.right;
        if (tl.right != null) {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到此，左平衡与右平衡操作也就讲解完了，主要思想是采用的分治思想，大问题化为小问题，然后逐个解决，到这里，如果能全部理解，那么AVL树的最核心部分就完全理解了，对于红黑树来说上面也是很核心的部分。</p><h3 id="avl树的创建过程" tabindex="-1"><a class="header-anchor" href="#avl树的创建过程"><span>AVL树的创建过程</span></a></h3><p>这部分我们主要了解下怎么创建AVL树，也就是添加元素方法的整体逻辑。</p><p>先看下每个结点类所包含的信息：</p><div class="language-C line-numbers-mode" data-ext="C" data-title="C"><pre class="language-C"><code>public class Node&lt;E extends Comparable&lt;E&gt;&gt;{
       E element; // data
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最主要的是每个结点类添加了一个balance属性，也就是记录自己的平衡因子，在插入元素的时候需要动态的调整。</p><p>我们看下插入元素方法的Java实现：</p><div class="language-C line-numbers-mode" data-ext="C" data-title="C"><pre class="language-C"><code>public boolean addElement(E element) {
    Node&lt;E&gt; t = root;
