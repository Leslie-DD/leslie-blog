import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as c,c as r,a as n,d as a,w as t,b as s,e as o}from"./app-BMIN2c_3.js";const u="/leslie-blog/assets/divide-and-conquer-1-D0DMN13O.png",d="/leslie-blog/assets/divide-and-conquer-2-DGUziIPx.png",k={},h=o('<p>author: fudonglai, AngelKitty, labuladong</p><p>本页面将介绍递归与分治算法的区别与结合运用。</p><h2 id="递归" tabindex="-1"><a class="header-anchor" href="#递归"><span>递归</span></a></h2><h3 id="定义" tabindex="-1"><a class="header-anchor" href="#定义"><span>定义</span></a></h3><p>递归（英语：Recursion），在数学和计算机科学中是指在函数的定义中使用函数自身的方法，在计算机科学中还额外指一种通过重复将问题分解为同类的子问题而解决问题的方法。</p><h3 id="引入" tabindex="-1"><a class="header-anchor" href="#引入"><span>引入</span></a></h3><blockquote><p>要理解递归，就得先理解什么是递归。</p></blockquote><p>递归的基本思想是某个函数直接或者间接地调用自身，这样原问题的求解就转换为了许多性质相同但是规模更小的子问题。求解时只需要关注如何把原问题划分成符合条件的子问题，而不需要过分关注这个子问题是如何被解决的。</p><p>以下是一些有助于理解递归的例子：</p>',9),m=n("li",null,"如何给一堆数字排序？答：分成两半，先排左半边再排右半边，最后合并就行了，至于怎么排左边和右边，请重新阅读这句话。",-1),g=n("li",null,"你今年几岁？答：去年的岁数加一岁，1999 年我出生。",-1),v=n("li",null,[n("img",{src:u,alt:"一个用于理解递归的例子"})],-1),f=o(`<p>递归在数学中非常常见。例如，集合论对自然数的正式定义是：1 是一个自然数，每个自然数都有一个后继，这一个后继也是自然数。</p><p>递归代码最重要的两个特征：结束条件和自我调用。自我调用是在解决子问题，而结束条件定义了最简子问题的答案。</p><div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre class="language-cpp"><code><span class="token keyword">int</span> <span class="token function">func</span><span class="token punctuation">(</span>传入数值<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="为什么要写递归" tabindex="-1"><a class="header-anchor" href="#为什么要写递归"><span>为什么要写递归</span></a></h3>`,4),b=n("div",{class:"hint-container info"},[n("p",{class:"hint-container-title"},'"C++"'),n("pre",null,[n("code",null,`\`\`\`cpp
// 不使用递归的归并排序算法
template <typename T>
...
\`\`\`
`)])],-1),_=n("div",{class:"hint-container info"},[n("p",{class:"hint-container-title"},'"Python"'),n("pre",null,[n("code",null,`\`\`\`python
# 不使用递归的归并排序算法
def merge_sort(a):
  n = len(a)
  seg, start = 1, 0
...
def merge_sort(a, front, end):
  ...
  merge(a, front, mid, end)
\`\`\`
`)])],-1),y=n("p",null,"显然，递归版本比非递归版本更易理解。递归版本的做法一目了然：把左半边排序，把右半边排序，最后合并两边。而非递归版本看起来不知所云，充斥着各种难以理解的边界计算细节，特别容易出 bug，且难以调试。",-1),w=n("li",null,[n("p",null,"练习分析问题的结构。当发现问题可以被分解成相同结构的小问题时，递归写多了就能敏锐发现这个特点，进而高效解决问题。")],-1),x=o(`<h3 id="递归的缺点" tabindex="-1"><a class="header-anchor" href="#递归的缺点"><span>递归的缺点</span></a></h3><p>在程序执行中，递归是利用堆栈来实现的。每当进入一个函数调用，栈就会增加一层栈帧，每次函数返回，栈就会减少一层栈帧。而栈不是无限大的，当递归层数过多时，就会造成 <strong>栈溢出</strong> 的后果。</p><p>显然有时候递归处理是高效的，比如归并排序；<strong>有时候是低效的</strong>，比如数孙悟空身上的毛，因为堆栈会消耗额外空间，而简单的递推不会消耗空间。比如这个例子，给一个链表头，计算它的长度：</p><div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre class="language-cpp"><code><span class="token comment">// 典型的递推遍历框架</span>
...
<span class="token keyword">int</span> <span class="token function">size_recursion</span><span class="token punctuation">(</span>Node <span class="token operator">*</span>head<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span>head <span class="token operator">==</span> <span class="token keyword">nullptr</span><span class="token punctuation">)</span> <span class="token keyword">return</span> <span class="token number">0</span><span class="token punctuation">;</span>
  <span class="token keyword">return</span> <span class="token function">size_recursion</span><span class="token punctuation">(</span>head<span class="token operator">-&gt;</span>next<span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+d+'" alt="二者的对比，compiler 设为 Clang 10.0，优化设为 O1(https://quick-bench.com/q/rZ7jWPmSdltparOO5ndLgmS9BVc)" title="[二者的对比，compiler 设为 Clang 10.0，优化设为 O1](https://quick-bench.com/q/rZ7jWPmSdltparOO5ndLgmS9BVc)"></p><h3 id="递归的优化" tabindex="-1"><a class="header-anchor" href="#递归的优化"><span>递归的优化</span></a></h3>',6),q=o('<p>比较初级的递归实现可能递归次数太多，容易超时。这时需要对递归进行优化。<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1"></a></sup></p><h2 id="分治" tabindex="-1"><a class="header-anchor" href="#分治"><span>分治</span></a></h2><h3 id="定义-1" tabindex="-1"><a class="header-anchor" href="#定义-1"><span>定义</span></a></h3><p>分治（英语：Divide and Conquer），字面上的解释是「分而治之」，就是把一个复杂的问题分成两个或更多的相同或相似的子问题，直到最后子问题可以简单的直接求解，原问题的解即子问题的解的合并。</p><h3 id="过程" tabindex="-1"><a class="header-anchor" href="#过程"><span>过程</span></a></h3><p>分治算法的核心思想就是「分而治之」。</p><p>大概的流程可以分为三步：分解 -&gt; 解决 -&gt; 合并。</p><ol><li>分解原问题为结构相同的子问题。</li><li>分解到某个容易求解的边界之后，进行递归求解。</li><li>将子问题的解合并成原问题的解。</li></ol><p>分治法能解决的问题一般有如下特征：</p><ul><li>该问题的规模缩小到一定的程度就可以容易地解决。</li><li>该问题可以分解为若干个规模较小的相同问题，即该问题具有最优子结构性质，利用该问题分解出的子问题的解可以合并为该问题的解。</li><li>该问题所分解出的各个子问题是相互独立的，即子问题之间不包含公共的子问题。</li></ul>',10),N=n("br",null,null,-1),S=o(`<p>以归并排序为例。假设实现归并排序的函数名为 <code>merge_sort</code>。明确该函数的职责，即 <strong>对传入的一个数组排序</strong>。这个问题显然可以分解。给一个数组排序等于给该数组的左右两半分别排序，然后合并成一个数组。</p><div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre class="language-cpp"><code><span class="token keyword">void</span> <span class="token function">merge_sort</span><span class="token punctuation">(</span>一个数组<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这几行代码就足以遍历任何一棵二叉树了。对于递归函数 <code>traverse(root)</code>，只要相信给它一个根节点 <code>root</code>，它就能遍历这棵树。所以只需要把这个节点的左右节点再传给这个函数就行了。</p><p>同样扩展到遍历一棵 N 叉树。与二叉树的写法一模一样。不过，对于 N 叉树，显然没有中序遍历。</p><div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre class="language-cpp"><code><span class="token keyword">void</span> <span class="token function">traverse</span><span class="token punctuation">(</span>TreeNode<span class="token operator">*</span> root<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span>root <span class="token operator">==</span> <span class="token keyword">nullptr</span><span class="token punctuation">)</span> <span class="token keyword">return</span><span class="token punctuation">;</span>
 ...
 */
\`\`\`
</code></pre></div><div class="hint-container info"><p class="hint-container-title">&quot;参考代码&quot;</p><div class="language-cpp line-numbers-mode" data-ext="cpp" data-title="cpp"><pre class="language-cpp"><code><span class="token keyword">int</span> <span class="token function">pathSum</span><span class="token punctuation">(</span>TreeNode <span class="token operator">*</span>root<span class="token punctuation">,</span> <span class="token keyword">int</span> sum<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
::: info &quot;参考代码（附注释）&quot;
    ...
    \`\`\`
:::
</code></pre></div><pre><code>还是那句话，**明白每个函数能做的事，并相信它们能够完成。**

总结下，\`PathSum\` 函数提供了二叉树遍历框架，在遍历中对每个节点调用 \`count\` 函数（这里用的是先序遍历，不过中序遍历和后序遍历也可以）。\`count\` 函数也是一个二叉树遍历，用于寻找以该节点开头的目标值路径。
</code></pre><h2 id="习题" tabindex="-1"><a class="header-anchor" href="#习题"><span>习题</span></a></h2>`,23),L={href:"https://leetcode.com/explore/learn/card/recursion-i/",target:"_blank",rel:"noopener noreferrer"},T={href:"https://leetcode.com/tag/divide-and-conquer/",target:"_blank",rel:"noopener noreferrer"},P=n("h2",{id:"参考资料与注释",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#参考资料与注释"},[n("span",null,"参考资料与注释")])],-1),O=n("hr",{class:"footnotes-sep"},null,-1),z={class:"footnotes"},C={class:"footnotes-list"},I={id:"footnote1",class:"footnote-item"},V={href:"https://labuladong.gitbook.io/algo/suan-fa-si-wei-xi-lie/di-gui-xiang-jie",target:"_blank",rel:"noopener noreferrer"},B=n("a",{href:"#footnote-ref1",class:"footnote-backref"},"↩︎",-1);function D(R,Z){const e=l("RouteLink"),p=l("ExternalLinkIcon");return c(),r("div",null,[h,n("ol",null,[n("li",null,[a(e,{to:"/algorithms/sort/divide-and-conquer.html"},{default:t(()=>[s("什么是递归？")]),_:1})]),m,g,v]),f,n("ol",null,[n("li",null,[n("p",null,[s("结构清晰，可读性强。例如，分别用不同的方法实现 "),a(e,{to:"/algorithms/sort/merge-sort.html"},{default:t(()=>[s("归并排序")]),_:1}),s("：")]),b,_,y]),w]),x,n("p",null,[s("主页面："),a(e,{to:"/algorithms/search/opt.html"},{default:t(()=>[s("搜索优化")]),_:1}),s(" 和 "),a(e,{to:"/algorithms/dp/memo.html"},{default:t(()=>[s("记忆化搜索")]),_:1})]),q,n("p",null,[s('???+ warning "注意"'),N,s(" 如果各子问题是不独立的，则分治法要重复地解公共的子问题，也就做了许多不必要的工作。此时虽然也可用分治法，但一般用 "),a(e,{to:"/algorithms/dp/basic.html"},{default:t(()=>[s("动态规划")]),_:1}),s(" 较好。")]),S,n("ul",null,[n("li",null,[n("a",L,[s("LeetCode 上的递归专题练习"),a(p)])]),n("li",null,[n("a",T,[s("LeetCode 上的分治算法专项练习"),a(p)])])]),P,O,n("section",z,[n("ol",C,[n("li",I,[n("p",null,[n("a",V,[s("labuladong 的算法小抄 - 递归详解"),a(p)]),s(),B])])])])])}const K=i(k,[["render",D],["__file","divide-and-conquer.html.vue"]]),M=JSON.parse('{"path":"/algorithms/sort/divide-and-conquer.html","title":"","lang":"zh-CN","frontmatter":{"description":"author: fudonglai, AngelKitty, labuladong 本页面将介绍递归与分治算法的区别与结合运用。 递归 定义 递归（英语：Recursion），在数学和计算机科学中是指在函数的定义中使用函数自身的方法，在计算机科学中还额外指一种通过重复将问题分解为同类的子问题而解决问题的方法。 引入 要理解递归，就得先理解什么是递归。 ...","head":[["meta",{"property":"og:url","content":"https://leslie-dd.github.io/leslie-blog/leslie-blog/algorithms/sort/divide-and-conquer.html"}],["meta",{"property":"og:site_name","content":"Leslie的博客"}],["meta",{"property":"og:description","content":"author: fudonglai, AngelKitty, labuladong 本页面将介绍递归与分治算法的区别与结合运用。 递归 定义 递归（英语：Recursion），在数学和计算机科学中是指在函数的定义中使用函数自身的方法，在计算机科学中还额外指一种通过重复将问题分解为同类的子问题而解决问题的方法。 引入 要理解递归，就得先理解什么是递归。 ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://quick-bench.com/q/rZ7jWPmSdltparOO5ndLgmS9BVc"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-04-19T07:24:37.000Z"}],["meta",{"property":"article:author","content":"Leslie"}],["meta",{"property":"article:modified_time","content":"2024-04-19T07:24:37.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"\\",\\"image\\":[\\"https://quick-bench.com/q/rZ7jWPmSdltparOO5ndLgmS9BVc\\"],\\"dateModified\\":\\"2024-04-19T07:24:37.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Leslie\\",\\"url\\":\\"https://mrhope.site\\"}]}"]]},"headers":[{"level":2,"title":"递归","slug":"递归","link":"#递归","children":[{"level":3,"title":"定义","slug":"定义","link":"#定义","children":[]},{"level":3,"title":"引入","slug":"引入","link":"#引入","children":[]},{"level":3,"title":"为什么要写递归","slug":"为什么要写递归","link":"#为什么要写递归","children":[]},{"level":3,"title":"递归的缺点","slug":"递归的缺点","link":"#递归的缺点","children":[]},{"level":3,"title":"递归的优化","slug":"递归的优化","link":"#递归的优化","children":[]}]},{"level":2,"title":"分治","slug":"分治","link":"#分治","children":[{"level":3,"title":"定义","slug":"定义-1","link":"#定义-1","children":[]},{"level":3,"title":"过程","slug":"过程","link":"#过程","children":[]}]},{"level":2,"title":"要点","slug":"要点","link":"#要点","children":[{"level":3,"title":"写递归的要点","slug":"写递归的要点","link":"#写递归的要点","children":[]}]},{"level":2,"title":"区别","slug":"区别","link":"#区别","children":[{"level":3,"title":"递归与枚举的区别","slug":"递归与枚举的区别","link":"#递归与枚举的区别","children":[]},{"level":3,"title":"递归与分治的区别","slug":"递归与分治的区别","link":"#递归与分治的区别","children":[]}]},{"level":2,"title":"例题详解","slug":"例题详解","link":"#例题详解","children":[]},{"level":2,"title":"习题","slug":"习题","link":"#习题","children":[]},{"level":2,"title":"参考资料与注释","slug":"参考资料与注释","link":"#参考资料与注释","children":[]}],"git":{"createdTime":1713511477000,"updatedTime":1713511477000,"contributors":[{"name":"Leslie","email":"LeslieDYF@gmail.com","commits":1}]},"readingTime":{"minutes":9.6,"words":2880},"filePathRelative":"algorithms/sort/divide-and-conquer.md","localizedDate":"2024年4月19日","excerpt":"<p>author: fudonglai, AngelKitty, labuladong</p>\\n<p>本页面将介绍递归与分治算法的区别与结合运用。</p>\\n<h2>递归</h2>\\n<h3>定义</h3>\\n<p>递归（英语：Recursion），在数学和计算机科学中是指在函数的定义中使用函数自身的方法，在计算机科学中还额外指一种通过重复将问题分解为同类的子问题而解决问题的方法。</p>\\n<h3>引入</h3>\\n<blockquote>\\n<p>要理解递归，就得先理解什么是递归。</p>\\n</blockquote>\\n<p>递归的基本思想是某个函数直接或者间接地调用自身，这样原问题的求解就转换为了许多性质相同但是规模更小的子问题。求解时只需要关注如何把原问题划分成符合条件的子问题，而不需要过分关注这个子问题是如何被解决的。</p>","autoDesc":true}');export{K as comp,M as data};
