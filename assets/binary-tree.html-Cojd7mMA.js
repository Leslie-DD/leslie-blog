...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div><p>很简单，就是判断左边与右边哪边不平衡，进而进行左平衡或者右平衡操作，至于左平衡右平衡上面已经详细讲解过，不在过多说明。</p><p>好了，以上就是构建一颗AVL树的过程讲解，如果有不懂得地方可以静下心来自己好好分析一下。</p><h3 id="avl树总结" tabindex="-1"><a class="header-anchor" href="#avl树总结"><span>AVL树总结</span></a></h3><p>本篇主要讲解了AVL的概念以及通过最基础的左旋，右旋使其保持树中每一个结点的平衡因子值保证在「-1，0，1」中，这样构建出来的树具有很好的查找特性。</p><p>AVL树相对于红黑树来说是一颗严格的平衡二叉树，平衡条件非常严格（树高差只有1），只要插入或删除不满足上面的条件就要通过旋转来保持平衡。由于旋转是非常耗费时间的。AVL树适合用于插入删除次数比较少，但查找多的情况。</p><p>在平衡二叉树中应用比较多的是红黑树，红黑树对高度差要求没有AVL那么严格，用以保持平衡的左旋右旋操作次数比较少，用于搜索时，插入删除次数多的情况下通常用红黑树来取代AVL树。TreeMap的实现以及JDK1.8以后的HashMap中都有红黑树的具体应用。</p>`,102),f=[g];function L(_,E){return i(),n("div",null,f)}const x=e(h,[["render",L],["__file","binary-tree.html.vue"]]),C=JSON.parse('{"path":"/datastructure/tree/binary-tree.html","title":"二叉树","lang":"zh-CN","frontmatter":{"title":"二叉树","author":"Leslie-D","editLink":false,"comment":false,"date":"2024-04-18T00:00:00.000Z","description":"二叉树 定义 二叉搜索树是一种二叉树的树形数据结构，其定义如下： 空树是二叉搜索树。 若二叉搜索树的左子树不为空，则其左子树上所有点的附加权值均小于其根节点的值。 若二叉搜索树的右子树不为空，则其右子树上所有点的附加权值均大于其根节点的值。 二叉搜索树的左右子树均为二叉搜索树。 二叉搜索树上的基本操作所花费的时间与这棵树的高度成正比。对于一个有 n 个...","head":[["meta",{"property":"og:url","content":"https://leslie-dd.github.io/leslie-blog/leslie-blog/datastructure/tree/binary-tree.html"}],["meta",{"property":"og:site_name","content":"Leslie的博客"}],["meta",{"property":"og:title","content":"二叉树"}],["meta",{"property":"og:description","content":"二叉树 定义 二叉搜索树是一种二叉树的树形数据结构，其定义如下： 空树是二叉搜索树。 若二叉搜索树的左子树不为空，则其左子树上所有点的附加权值均小于其根节点的值。 若二叉搜索树的右子树不为空，则其右子树上所有点的附加权值均大于其根节点的值。 二叉搜索树的左右子树均为二叉搜索树。 二叉搜索树上的基本操作所花费的时间与这棵树的高度成正比。对于一个有 n 个..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-04-19T07:24:37.000Z"}],["meta",{"property":"article:author","content":"Leslie-D"}],["meta",{"property":"article:published_time","content":"2024-04-18T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-04-19T07:24:37.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"二叉树\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-04-18T00:00:00.000Z\\",\\"dateModified\\":\\"2024-04-19T07:24:37.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Leslie-D\\"}]}"]]},"headers":[{"level":2,"title":"二叉树","slug":"二叉树","link":"#二叉树","children":[{"level":3,"title":"定义","slug":"定义","link":"#定义","children":[]}]},{"level":2,"title":"AVL 树（平衡二叉查找树）","slug":"avl-树-平衡二叉查找树","link":"#avl-树-平衡二叉查找树","children":[{"level":3,"title":"定义","slug":"定义-1","link":"#定义-1","children":[]},{"level":3,"title":"性质","slug":"性质","link":"#性质","children":[]},{"level":3,"title":"操作","slug":"操作","link":"#操作","children":[]},{"level":3,"title":"AVL树的创建过程","slug":"avl树的创建过程","link":"#avl树的创建过程","children":[]},{"level":3,"title":"AVL树总结","slug":"avl树总结","link":"#avl树总结","children":[]}]}],"git":{"createdTime":1713432368000,"updatedTime":1713511477000,"contributors":[{"name":"Leslie","email":"LeslieDYF@gmail.com","commits":1}]},"readingTime":{"minutes":14.49,"words":4346},"filePathRelative":"datastructure/tree/binary-tree.md","localizedDate":"2024年4月18日","excerpt":"<h2>二叉树</h2>\\n<h3>定义</h3>\\n<p>二叉搜索树是一种二叉树的树形数据结构，其定义如下：</p>\\n<ol>\\n<li>空树是二叉搜索树。</li>\\n<li>若二叉搜索树的左子树不为空，则其左子树上所有点的附加权值均小于其根节点的值。</li>\\n<li>若二叉搜索树的右子树不为空，则其右子树上所有点的附加权值均大于其根节点的值。</li>\\n<li>二叉搜索树的左右子树均为二叉搜索树。</li>\\n</ol>\\n<p>二叉搜索树上的基本操作所花费的时间与这棵树的高度成正比。对于一个有 n 个结点的二叉搜索树中，这些操作的最优时间复杂度为 O(\\\\log n)，最坏为 O(n)。随机构造这样一棵二叉搜索树的期望高度为 <code>O(log n)</code>。</p>","autoDesc":true}');export{x as comp,C as data};
